...
class Workspace:
    def __init__(self, cfg):
        ...
        self.explorer = hydra.utils.instantiate(
            self.cfg.explorer,
            obs_channel=self.train_env.observation_spec().shape[0],
    ...
    def setup(self):
        ...
        self.replay_loader = make_replay_loader(
            ...
            self.cfg.save_snapshot, 1, self.cfg.discount)
    ...
    def eval(self):
        ...
        while eval_until_episode(episode):
            ...
            while not time_step.last():
                with torch.no_grad(), utils.eval_mode(self.explorer):
                    action, reward, next_feature = self.explorer.act(time_step.observation,
                                               self.global_step,
                                               eval_mode=True)
    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            ...
            if not seed_until_step(self.global_step):
                metrics = self.explorer.update(self.replay_iter, self.global_step)
    ...
    def save_snapshot(self):
        ...
        keys_to_save = ['explorer', 'timer', '_global_step', '_global_episode']
